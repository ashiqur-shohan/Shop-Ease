...
SECRET_KEY = 'django-insecure-94*_cp1xmw)jlm8$l=n5!@nohg=&eyb+i=xmgv0c-1g8uvx^$='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['shop-ease-ldly.onrender.com', '127.0.0.1']
...
AUTHENTICATION_BACKENDS = (
    # built username dara validate korar jonno
